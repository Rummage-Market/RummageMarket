...
프로젝트가 거의 끝날 무렵 테스트를 해보면서 추가하고 싶은 기능들이 계속 생겼습니다. 예를 들어서 판매중 혹은 거래완료 표시, 관리자 페이지, 문의 게시판, 채팅기능 등이 있습니다. 정해진 프로젝트 기간 내에 수행하지 못할 것 같아서 추후에 하기로 미뤘는데 지금 생각을 해보았을 때 좀 더 욕심을 내는 것이 좋았을까 하는 생각이 듭니다.
